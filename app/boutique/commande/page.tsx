...
export default function CheckoutPage() {
  ...
  function handlePaymentError(msg: string) {
    toast.error(msg || 'Paiement refusé, veuillez réessayer')
  }
        ...
        <div className="lg:col-span-2">
          ...
          {step === 'payment' && checkoutId && (
            <div className="card p-6">
              <h2 className="font-playfair text-lg font-semibold text-charcoal mb-6">Paiement sécurisé</h2>
              <SumUpWidget
                checkoutId={checkoutId}
                onSuccess={handlePaymentSuccess}
                onError={handlePaymentError}
              />
              <div className="flex items-center justify-center gap-2 mt-6 text-xs text-nude-dark">
                <Lock size={12} />
